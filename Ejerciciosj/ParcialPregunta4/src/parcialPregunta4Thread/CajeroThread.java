...
import parcialPregunta4Thread.ClienteThread;
...
public class CajeroThread extends Thread{
    ...
    private final int cantidad200 = 60,cantidad100 = 100,cantidad50 = 200,cantidad20 = 500;
    private int dc=0,cn=0,cc=0,vn=0;
    private int ini,fin,cont;
    
    List<ClienteThread> cliente;
    
    public CajeroThread(List<ClienteThread> cliente,int ini,int fin)
    {
